...
Investigar la distribución de espaciamientos entre niveles de energía adyacentes (si​=Ei+1​−Ei​)  para comparar dos tipos de sistemas:
    ...
    Sistemas Integrables: Representados por un billar rectangular, donde los niveles de energía no están correlacionados y siguen una distribución de Poisson.
...
# Metodología
    ...
    Cálculo de los primeros 500-1000 autovalores (kn2​) para cada geometría.

    Visualización de densidades de probabilidad cuántica ∣ψ(x,y)∣2 para identificar "cicatrices" (scars) de órbitas clásicas.
