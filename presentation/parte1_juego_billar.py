...
def play_parte1(scene):
    """
    Section 1: Billiard Game - Chaotic vs Deterministic
    """
    # 1: Title "Chaotic vs Deterministic"
    titulo = Text("Chaotic vs Deterministic", font_size=48, color=BLUE)
    
    scene.play(Write(titulo))
    scene.next_slide()
    
    # 2: Rectangular Billiard
    ...
    # 6: Schrödinger Equation & Linearity
