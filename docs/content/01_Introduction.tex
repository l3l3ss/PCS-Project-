...
The study of complex systems allows to explore the transition between the classical order and the statistichal manifestations in the quantum regime. As in classical mechanics chaos isdefined as the exponential sensitivity to initial conditions, the linearity in the Schrödinger equation does not allow for a direct translation of this definition to quantum mechanics. 
...
To validate this hipothesis, we'll investigate the distribution of spacing between adjacent energy levels in two systems ($s_i$): one integrable and one chaotic. 
